...
# Structural regressions around setup.ps1 control flow:
# - SKIP_STUDIO_FRONTEND=1 can still need Node for the checked-in OXC runtime.
#   NodeSource must therefore be initialized before the frontend skip branch.
# - A typo in UNSLOTH_STUDIO_HOME/STUDIO_HOME must fail before NodeParent is
#   created, otherwise the typo is materialized and later leaves a partial tree.
